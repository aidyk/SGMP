...
class HolonomicRRTstarNode : public CHolonomicPathNode
{
	public:
		HolonomicRRTstarNode(const C4Vector& rotAxisRot,const C4Vector& rotAxisRotInv);
		HolonomicRRTstarNode(int theType,const C7Vector& conf,const C4Vector& rotAxisRot,const C4Vector& rotAxisRotInv);
		HolonomicRRTstarNode(int theType,float searchMin[4],float searchRange[4],const C4Vector& rotAxisRot,const C4Vector& rotAxisRotInv);
		virtual ~HolonomicRRTstarNode();

		virtual HolonomicRRTstarNode* copyYourself();
