...
HolonomicRRTNode::HolonomicRRTNode(const C4Vector& rotAxisRot, const C4Vector& rotAxisRotInv)
  : CHolonomicPathNode(rotAxisRot, rotAxisRotInv) {
	_cost = 0.0;
}

HolonomicRRTNode::HolonomicRRTNode(int theType, const C7Vector& conf, const C4Vector& rotAxisRot, const C4Vector& rotAxisRotInv)
  : CHolonomicPathNode(theType, conf, rotAxisRot, rotAxisRotInv) {
  _cost = 0.0;
}

HolonomicRRTNode::HolonomicRRTNode(int theType, float searchMin[4], float searchRange[4],
...
HolonomicRRTNode::~HolonomicRRTNode() {
}

HolonomicRRTNode* HolonomicRRTNode::copyYourself() {
  HolonomicRRTNode* newNode = new HolonomicRRTNode(_rotAxisRot, _rotAxisRotInv);
...
void HolonomicRRTNode::removeChild(HolonomicRRTNode *child) {
  bool flag = false;
...
void HolonomicRRTNode::updateChildrenCosts(float delta_cost) {
  for (int i = 0; i < int(_children.size()); i++) {
