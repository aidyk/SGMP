...
HolonomicBiRRTNode::HolonomicBiRRTNode(const C4Vector& rotAxisRot, const C4Vector& rotAxisRotInv)
  : CHolonomicPathNode(rotAxisRot, rotAxisRotInv) {
}

HolonomicBiRRTNode::HolonomicBiRRTNode(int theType, const C7Vector& conf, const C4Vector& rotAxisRot, const C4Vector& rotAxisRotInv)
  : CHolonomicPathNode(theType, conf, rotAxisRot, rotAxisRotInv) {
}

HolonomicBiRRTNode::HolonomicBiRRTNode(int theType, float searchMin[4], float searchRange[4],
...
HolonomicBiRRTNode::~HolonomicBiRRTNode() {
}

HolonomicBiRRTNode* HolonomicBiRRTNode::copyYourself() {
  HolonomicBiRRTNode* newNode = new HolonomicBiRRTNode(_rotAxisRot, _rotAxisRotInv);
