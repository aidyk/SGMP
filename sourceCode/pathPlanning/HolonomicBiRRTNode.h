...
class HolonomicBiRRTNode : public CHolonomicPathNode
{
	public:
		HolonomicBiRRTNode(const C4Vector& rotAxisRot,const C4Vector& rotAxisRotInv);
		HolonomicBiRRTNode(int theType,const C7Vector& conf,const C4Vector& rotAxisRot,const C4Vector& rotAxisRotInv);
		HolonomicBiRRTNode(int theType,float searchMin[4],float searchRange[4],const C4Vector& rotAxisRot,const C4Vector& rotAxisRotInv);
		virtual ~HolonomicBiRRTNode();

		virtual HolonomicBiRRTNode* copyYourself();
};
